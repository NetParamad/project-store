...
export default async function HomePage() {
  ...
  const testimonials = [
    ...
    { text: "ขอบคุณพี่บาส พี่เล็กแบบ มากๆๆๆๆๆๆๆๆๆเลยนะคะ แบบไม่เสียใจเลยจริงๆที่ให้ พี่ๆดูแล งานประณีตมากๆๆ ดูแลอย่างดี ประทับใจมากๆ เลยค่ะ ขอบคุณอีกครั้งจริงๆ นะคะ", author: "— เอมิลี่ & เดวิด", initial: "ช" },
